 ...
 if(isset($_REQUEST['psubmit'])){
  ...
  if(($_REQUEST['cname'] == "") || ($_REQUEST['cadd'] == "") || ($_REQUEST['pname'] == "") || ($_REQUEST['pquantity'] == "") || ($_REQUEST['psellingcost'] == "") || ($_REQUEST['totalcost'] == "") || ($_REQUEST['selldate'] == "")){
   ...
   $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
    ...
    $sqlin = "INSERT INTO customer_tb(c_name, c_add, c_prod_name, c_prod_qty, c_prod_price, c_total_prod, c_prod_date) VALUES ('$custname','$custadd', '$cpname', '$cpquantity', '$cpeach', '$cptotal', '$cpdate')";
    ...
    $sql = "UPDATE assets_tb SET p_avil = '$pava' WHERE p_id = '$pid'";
    $conn->query($sql);
  }
}
 ?>
