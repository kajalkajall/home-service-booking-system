...
if(isset($_REQUEST['psubmit'])){
 ...
 if(($_REQUEST['pname'] == "") || ($_REQUEST['pdop'] == "") || ($_REQUEST['pava'] == "") || ($_REQUEST['ptotal'] == "") || ($_REQUEST['poriginalcost'] == "") || ($_REQUEST['psellingcost'] == "")){
  ...
  $psellingcost = $_REQUEST['psellingcost'];
   $sql = "INSERT INTO assets_tb (p_name, p_dop, p_avil, p_total, p_og_cost, p_sell_price) VALUES ('$pname', '$pdop','$pava', '$ptotal', '$poriginalcost', '$psellingcost')";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="POST">
    ...
    <div class="text-center">
      <button type="submit" class="btn btn-secondary" id="psubmit" name="psubmit">Submit</button>
